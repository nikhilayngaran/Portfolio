...
export const projects: Project[] = [
  ...
  },
  {
    ...
    objective: `Lindt & Sprüngli faces a growing tension at the intersection of brand ambition and environmental responsibility. While the company has committed to science-based emissions targets and a net-zero roadmap, its digital advertising operations remain a largely unmeasured source of Scope 3 carbon emissions. The objective of this project was to develop a corporate strategy that allows Lindt to grow its digital marketing presence without expanding its environmental footprint, positioning sustainability not as a constraint but as a competitive advantage.`,
    analysis: `The project began by challenging a common assumption: that going digital automatically means going green. Research revealed that online advertising consumed 106 TWh of energy globally in 2016, generating 60 million tonnes of CO₂, driven largely by AI-powered ad targeting, programmatic networks, and energy-intensive data centres. A direct carbon audit comparing Lindt's website against L'Oréal's made the gap concrete and urgent. Competitor benchmarking surfaced two leading practices: Dentsu and Nestlé achieved a 25% reduction in digital ad emissions through Scope3's diagnostics-to-delivery model, while L'Oréal earned shortlisting for the Ad Net Zero Best Practice in Sustainability award.`,
    recommendations: {
      intro: "Four strategic pillars:",
      pillars: [
        {
          title: "Measure It",
          body: "Track carbon across ad impressions, data centres, supply chain partners, and geographic delivery patterns. Without a baseline, there is no strategy. Align with Lindt's existing Scope 3 data commitments to avoid duplicating effort.",
        },
        {
          title: "Fix It",
          body: "Reduce programmatic waste by auditing the ad supply chain with Scope3. Migrate to green hosting. Shift budget toward lower-energy formats and direct publisher deals over open exchanges.",
        },
        {
          title: "Embed It",
          body: "Introduce sustainability KPIs for marketing teams. Tie performance reviews to carbon reduction targets. Reward teams that reduce emissions through in-house content and employee advocacy rather than high-energy external channels.",
        },
        {
          title: "Communicate It",
          body: "Once reductions are measurable and verified, build a brand narrative around them. Publish carbon credentials. Target eco-conscious consumers, retail partners facing their own Scope 3 pressure, and talent who expect purpose from an employer.",
        },
      ],
    },
    skills: [
      "Carbon Audit Methodology",
      "Scope 3 Communications Strategy",
  ...
  },
  {
    id: "sk38-nettoyage",
    number: "03",
    title: "SK38 Nettoyage",
    client: "SK38 Nettoyage | Freelance | Brand Identity & Web Design | Grenoble, France",
    clientLogo: "/sk38/logo.png",
    tags: ["Brand Identity", "Logo Design", "Web Design", "Print Design", "Freelance"],
    accent: "#C9A84C",
  ...
  },
  {
    ...
    client: "Passenger Clothing | MSc Innovation & Entrepreneurship, GEM | Digital Communication Strategy Module",
    clientLogo: "/logos/passenger.webp",
    tags: ["Digital Communication", "Brand Strategy", "Content Strategy", "Audience Segmentation", "Growth Marketing", "Social Media"],
    accent: "#4A7C59",
    accentSecondary: "#8B5E3C",
    objective: `Passenger Clothing is a UK-based outdoor lifestyle brand making sustainably produced apparel and bags from recycled materials. Their product line is visually distinctive, with bold, vibrant colorways designed for people who want to explore the outdoors without costing the planet anything extra.\n\nThe objective was to develop a complete digital communication strategy using a professional WHO-WHAT-HOW framework, identifying the highest-potential target audience, clarifying the brand positioning, and building a communication system with real KPIs, not just channel recommendations.`,
    analysis: `Five audience segments were identified and scored across seven product benefits. Active Urbanites represent 50% of market, with high versatility and lightweight needs, reachable via company social. Style Sharers at 30% prioritise aesthetics, multiple designs, and social benefit, and are native to Instagram and TikTok. Short-Trip Lovers (15%) value portability and comfort. Beginner Explorers (15%) prioritise versatility and lightweight. Eco-minded Users (20%) are driven by sustainability and social benefit.\n\nPriority target selected: Style Sharers. Not for their market size, but for strategic alignment. They are the most reachable segment (Instagram and TikTok native), the best need-offer fit (aesthetics and social benefit are Passenger's exact product strengths), and a multiplier where every purchase is potential organic reach.\n\nWhy not Active Urbanites despite being 50% of market: the biggest segment is not automatically the best target. Active Urbanites value versatility and function over aesthetics. Passenger's core strength is visual, not functional.\n\nConsumer Insight: Style Sharers face a specific tension. They want to be seen as adventurers but live predominantly urban lives. Passenger gives them permission to perform that outdoor identity all the time, not just when they are in nature. The bag is a signal. It says something about who they are and who they are becoming, before they have even left the city.`,
    recommendations: {
      intro: "A WHO-WHAT-HOW framework across three strategic layers:",
      pillars: [],
    },
    skills: [
